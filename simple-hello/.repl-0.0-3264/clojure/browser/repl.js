...
return (function (){
if(cljs.core.truth_((function (){var and__3352__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__5614 = script;
(G__5614["type"] = "text/javascript");

(G__5614["onload"] = onload);

(G__5614["onreadystatechange"] = onload);

return G__5614;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__5615 = script__$1;
(G__5615["src"] = src);

return G__5615;
})():(function (){var G__5616 = script__$1;
goog.dom.setTextContext(G__5616,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__3360__auto__ = reload;
...
var path_5617 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_5617];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_5617)].join('')];
} else {
}
