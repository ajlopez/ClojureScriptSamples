...
var script__$1 = (function (){var G__117 = script;
(G__117["type"] = "text/javascript");

(G__117["onload"] = onload);

(G__117["onreadystatechange"] = onload);

return G__117;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__118 = script__$1;
(G__118["src"] = src);

return G__118;
})():(function (){var G__119 = script__$1;
goog.dom.setTextContext(G__119,opt_sourceText);
...
var path_120 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_120];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_120)].join('')];
} else {
}
